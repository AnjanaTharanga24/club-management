...
export default function ViewMyClubs() {
  ...
  const getClubColor = (name) => {
    const colors = [
      'linear-gradient(135deg,rgb(33, 31, 23),rgb(44, 17, 221))',
    ];
              ...
              >
                ...
                <div className="club-content">
                  ...
                  <div className="club-address">
                    ...
                    <span>{club.clubAddress || 'No address provided'}</span>
                  </div>
                  <div className="club-members">
                    <i className="bi bi-people-fill"></i>
                    <span>{club.associatedMembers ? club.associatedMembers.length : 0} members</span>
                  </div>
                ...
                <div className="club-actions-btn">
                  <button className="club-action-btn" onClick={() => viewClub(club.clubId)}>
