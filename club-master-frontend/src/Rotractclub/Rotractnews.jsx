  ...
  const handleLike = async (id) => {
    try {
      ...
      if (interactions[id]?.liked) {
        await axios.post(`http://localhost:7000/api/v1/like/${id}/removeLikeNews/${clubId}/${memberId}`);
        ...
        await axios.post(`http://localhost:7000/api/v1/like/${id}/addLikeNews/${clubId}/${memberId}`);
                  ...
                  <div className="mt-6 flex items-center space-x-8">
                    ...
                    >
                      ...
                      <span className="ml-1 text-base font-semibold group-hover:text-red-600">
                        {item.like.membersLike ? item.like.membersLike.length : 0}
                      </span>
                    </button>
                    ...
                    >
                      ...
                      <span className="ml-1 text-base font-semibold group-hover:text-blue-600">
                        {item.like.membersDislike ? item.like.membersDislike.length : 0}
                      </span>
                    </button>
                  </div>
                </div>
