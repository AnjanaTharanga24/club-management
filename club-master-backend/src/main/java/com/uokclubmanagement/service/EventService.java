...
public interface EventService {
    ...
    Event createEvent(Event event, String clubId, String clubAdminId, MultipartFile eventImage) throws Exception;
    List<Event> getAllEvents();
    Event updateEventById(String clubAdminId, String eventId, Event event, MultipartFile newEventImage) throws Exception;
